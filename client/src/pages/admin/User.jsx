...
const User = () => {
  ...
  const [stopChange, setStopChange] = useState(null)
            ...
            <div className="cell">
              <div className="flex justify-center items-center">
                <div className="flex justify-center items-center">
                  <img
                    src={
                      e?.imageUrl && e.imageUrl.startsWith('https')
                        ? e.imageUrl
                        : e?.imageUrl
                          ? `http://localhost:8080/storage/avatar/${e.imageUrl}`
                          : avatarDefault // Sử dụng avatarDefault khi không có imageUrl
                    }
